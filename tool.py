...
argParser.add_argument("-a", "--virustotal", action="store_true", help="Disable virustotal", required=False)
argParser.add_argument("-vt", "--abuse", action="store_true", help="Disable AbuseIPDB", required=False)
